...
default:
	...
	nvcc -m64 -arch=sm_89 -O3 -c detect_collisions.cu -o detect_collisions.o -I$(CUDA_PATH)/include
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Wno-deprecated-copy -Ofast -ftree-vectorize -c deploy_kangaroos.cpp -o deploy_kangaroos.o -I$(CUDA_PATH)/include
